...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    narrative:
      "A personal AI agent that handles the tedious half of job searching — built on a hybrid local+cloud architecture where privacy and cost stay in your control.",
    year: 2026,
