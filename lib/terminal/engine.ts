...
function whoamiResponse(): Response {
  return {
    lines: [
      ...
      out("Now: Cortex, Parallax, Meridian — agents, eval, risk."),
      divider,
...
const FILTER_ALIASES: Record<string, ProjectFilter> = {
  ...
  mlops: { tags: ["MLflow", "FastAPI"], keywords: ["mlops", "infrastructure", "pipeline"] },
  infra: { keywords: ["infrastructure", "kafka", "fastapi"] },
  infrastructure: { keywords: ["infrastructure", "kafka"] },
  agent: { tags: ["Agentic AI", "MCP", "Agent Reliability"] },
  agentic: { tags: ["Agentic AI", "MCP"] },
  mcp: { tags: ["MCP"] },
  llm: { tags: ["LLM Evaluation", "Agentic AI"] },
  eval: { tags: ["LLM Evaluation", "Agent Reliability"] },
  evaluation: { tags: ["LLM Evaluation"] },
  ...
  meridian: { keywords: ["meridian", "supply", "risk"] },
  risk: { keywords: ["risk", "supply"] },
  supply: { keywords: ["supply", "risk"] },
  graph: { tags: ["Neo4j"], keywords: ["graph", "neo4j"] },
  kafka: { tags: ["Kafka"] },
  neo4j: { tags: ["Neo4j"] },
